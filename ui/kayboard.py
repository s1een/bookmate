...
# Inline
def create_inline(count):
    kb = InlineKeyboardMarkup(row_width=5)
    if count > 0:
        book_button1 = InlineKeyboardButton('1', callback_data='book 1')
        kb.add(book_button1)
    if count > 1:
        book_button2 = InlineKeyboardButton('2', callback_data='book 2')
        kb.insert(book_button2)
    if count > 2:
        book_button3 = InlineKeyboardButton('3', callback_data='book 3')
        kb.insert(book_button3)
    if count > 3:
        book_button4 = InlineKeyboardButton('4', callback_data='book 4')
        kb.insert(book_button4)
    if count > 4:
        book_button5 = InlineKeyboardButton('5', callback_data='book 5')
        kb.insert(book_button5)
    if count > 5:
        book_button6 = InlineKeyboardButton('6', callback_data='book 6')
        kb.insert(book_button6)
    if count > 6:
        book_button7 = InlineKeyboardButton('7', callback_data='book 7')
        kb.insert(book_button7)
    if count > 7:
        book_button8 = InlineKeyboardButton('8', callback_data='book 8')
        kb.insert(book_button8)
    if count > 8:
        book_button9 = InlineKeyboardButton('9', callback_data='book 9')
        kb.insert(book_button9)
    if count > 9:
        book_button10 = InlineKeyboardButton('10', callback_data='book 10')
...
def create_inline_wish(count):
    kb = InlineKeyboardMarkup(row_width=5)
    if count > 0:
        book_button1 = InlineKeyboardButton('1', callback_data='wishbook 1')
        kb.add(book_button1)
    if count > 1:
        book_button2 = InlineKeyboardButton('2', callback_data='wishbook 2')
        kb.insert(book_button2)
    if count > 2:
        book_button3 = InlineKeyboardButton('3', callback_data='wishbook 3')
        kb.insert(book_button3)
    if count > 3:
        book_button4 = InlineKeyboardButton('4', callback_data='wishbook 4')
        kb.insert(book_button4)
    if count > 4:
        book_button5 = InlineKeyboardButton('5', callback_data='wishbook 5')
        kb.insert(book_button5)
    if count > 5:
        book_button6 = InlineKeyboardButton('6', callback_data='wishbook 6')
        kb.insert(book_button6)
    if count > 6:
        book_button7 = InlineKeyboardButton('7', callback_data='wishbook 7')
        kb.insert(book_button7)
    if count > 7:
        book_button8 = InlineKeyboardButton('8', callback_data='wishbook 8')
        kb.insert(book_button8)
    if count > 8:
        book_button9 = InlineKeyboardButton('9', callback_data='wishbook 9')
        kb.insert(book_button9)
    if count > 9:
        book_button10 = InlineKeyboardButton('10', callback_data='wishbook 10')
        kb.insert(book_button10)
    back_button = InlineKeyboardButton('<-', callback_data='wish back')
    next_button = InlineKeyboardButton('->', callback_data='wish next')
    kb.add(back_button).insert(next_button)
    return kb
